<template>
  ...
  >
    <g>
      <path
        style="fill:#A5A5A5 "
        d="M24.1,54.2c-0.256,0-0.512-0.098-0.707-0.293c-0.391-0.391-0.391-1.023,0-1.414l4.2-4.2
		c0.391-0.391,1.023-0.391,1.414,0s0.391,1.023,0,1.414l-4.2,4.2C24.612,54.102,24.356,54.2,24.1,54.2z"
      />
      <path
        style="fill:#A5A5A5 "
        d="M28.3,55.6c-0.553,0-1-0.448-1-1V49c0-0.552,0.447-1,1-1s1,0.448,1,1v5.6
		C29.3,55.152,28.853,55.6,28.3,55.6z"
      />
      <path
        style="fill:#A5A5A5 "
        d="M32.5,54.2c-0.256,0-0.512-0.098-0.707-0.293l-4.2-4.2c-0.391-0.391-0.391-1.023,0-1.414
		s1.023-0.391,1.414,0l4.2,4.2c0.391,0.391,0.391,1.023,0,1.414C33.012,54.102,32.756,54.2,32.5,54.2z"
      />
      <path
        style="fill:#A5A5A5 "
        d="M35.301,51.4c-0.065,0-0.131-0.006-0.197-0.02l-7-1.4c-0.541-0.108-0.893-0.635-0.784-1.177
		c0.107-0.541,0.628-0.894,1.177-0.784l7,1.4c0.541,0.108,0.893,0.635,0.784,1.177C36.186,51.071,35.768,51.4,35.301,51.4z"
      />
      <path
        style="fill:#A5A5A5 "
        d="M21.299,51.167c-0.48,0-0.904-0.347-0.985-0.835c-0.091-0.545,0.277-1.06,0.822-1.151l7-1.167
      ...
      <path
        style="fill:#E9D3EA "
        d="M29.3,6.076V0l-4,2v4.157C14.369,7.425,5.933,16.879,6.312,28.236
		c0.366,10.957,9.166,20.038,20.108,20.721C38.92,49.737,49.3,39.831,49.3,27.5C49.3,16.132,40.471,6.849,29.3,6.076z"
      />
      <path
        style="fill:#9777A8 "
        d="M28.3,50.203c-0.103,0-0.207-0.016-0.311-0.05c-6.107-1.993-11.777-7.503-14.442-14.04
      ...
      <path
        style="fill:#9777A8 "
        d="M28.3,50.203c-0.421,0-0.813-0.268-0.951-0.69c-0.171-0.525,0.116-1.089,0.641-1.261
      ...
      <path
        style="fill:#9777A8 "
        d="M28.798,50.203c-0.169,0-0.34-0.042-0.497-0.133c-6.508-3.739-11.477-21.408-7.641-34.354
      ...
      <path
        style="fill:#9777A8 "
        d="M27.802,50.203c-0.347,0-0.684-0.18-0.868-0.502c-0.275-0.479-0.109-1.09,0.369-1.365
      ...
      <path
        style="fill:#9777A8 "
        d="M28.3,50c-0.553,0-1-0.448-1-1V12c0-0.552,0.447-1,1-1s1,0.448,1,1v37
